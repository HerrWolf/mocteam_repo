...
def login(username,password,token):
    ...
    # Service call
    service_url = urlparse.urljoin(get_base_url(),"processkodi.php")
    service_parameters = urllib.urlencode({'username':username,'password':password,'token':token})
